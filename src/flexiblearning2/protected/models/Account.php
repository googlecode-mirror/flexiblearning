...
class Account extends Base {
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'fullname' => Yii::t('flexiblearn', 'Full Name'),
            ...
            'avatar' => Yii::t('flexiblearn', 'Avatar'),
            'last_login' => Yii::t('flexiblearn', 'Last Login Date'),
            'ipAddress' => Yii::t('flexiblearn', 'Ip Address'),
            'favorite' => Yii::t('flexiblearn', 'Favorite'),
            'enabledFullName' => Yii::t('flexiblearn', 'Enable Full Name'),
            'enabledDateOfBirth' => Yii::t('flexiblearn', 'Enable Date Of Birth'),
            'enabledAddress' => Yii::t('flexiblearn', 'Enable Address'),
            'enabledNationality' => Yii::t('flexiblearn', 'Enable Nationality'),
            'enabledTel' => Yii::t('flexiblearn', 'Enable Telephone'),
            'enabledEmail' => Yii::t('flexiblearn', 'Enable Email'),
            'enabledProfession' => Yii::t('flexiblearn', 'Enable Profession'),
            'enabledFavorite' => Yii::t('flexiblearn', 'Enable Favorite')
        );
    }
