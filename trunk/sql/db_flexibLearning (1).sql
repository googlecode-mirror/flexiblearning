...
--
-- Host: localhost
-- Generation Time: Aug 24, 2011 at 11:53 PM
...
--
-- Table structure for table `accountcatagorize`
--
-- Creation: Aug 23, 2011 at 12:42 PM
--

CREATE TABLE IF NOT EXISTS `accountcatagorize` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `accountcatagorize`
--
...
--
-- Table structure for table `videocatagory`
--
-- Creation: Aug 24, 2011 at 07:00 AM
--

CREATE TABLE IF NOT EXISTS `videocatagory` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `IdLanguage` int(11) NOT NULL,
...
--
-- Dumping data for table `videocatagory`
--
...
--
-- Table structure for table `video_catagoryvideo`
--
-- Creation: Aug 24, 2011 at 07:49 AM
--

CREATE TABLE IF NOT EXISTS `video_catagoryvideo` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `IdVideo` int(11) NOT NULL,
  `IdCatagory` int(11) NOT NULL,
  `state` int(11) NOT NULL,
...
--
-- Dumping data for table `video_catagoryvideo`
--
...
--
ALTER TABLE `account`
  ADD CONSTRAINT `account_ibfk_4` FOREIGN KEY (`IdLanguage`) REFERENCES `account` (`IdLanguage`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `accountcatagorize`
--
ALTER TABLE `accountcatagorize`
  ADD CONSTRAINT `accountcatagorize_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `accountpermisson`
--
ALTER TABLE `accountpermisson`
  ADD CONSTRAINT `accountpermisson_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `account_catagory`
--
ALTER TABLE `account_catagory`
  ADD CONSTRAINT `account_catagory_ibfk_1` FOREIGN KEY (`IdAccount`) REFERENCES `account` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `account_catagory_ibfk_2` FOREIGN KEY (`IdCatagory`) REFERENCES `accountcatagorize` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `answer`
  ADD CONSTRAINT `answer_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `banner`
--
ALTER TABLE `banner`
  ADD CONSTRAINT `banner_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `entry`
--
ALTER TABLE `entry`
  ADD CONSTRAINT `entry_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `message`
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `nationality`
--
ALTER TABLE `nationality`
  ADD CONSTRAINT `nationality_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `partner`
--
ALTER TABLE `partner`
  ADD CONSTRAINT `partner_ibfk_1` FOREIGN KEY (`Idlanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `profession`
--
ALTER TABLE `profession`
  ADD CONSTRAINT `profession_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `question`
--
ALTER TABLE `question`
  ADD CONSTRAINT `question_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `videocatagory`
--
ALTER TABLE `videocatagory`
  ADD CONSTRAINT `videocatagory_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `videodocument`
--
ALTER TABLE `videodocument`
  ADD CONSTRAINT `videodocument_ibfk_1` FOREIGN KEY (`IdLanguage`) REFERENCES `language` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `video_catagoryvideo`
--
ALTER TABLE `video_catagoryvideo`
  ADD CONSTRAINT `video_catagoryvideo_ibfk_1` FOREIGN KEY (`IdVideo`) REFERENCES `video` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `video_catagoryvideo_ibfk_2` FOREIGN KEY (`IdCatagory`) REFERENCES `videocatagory` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
