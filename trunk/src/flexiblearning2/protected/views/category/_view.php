<div class="view">
    ...
    <?php echo Yii::app()->dateFormatter->format(Yii::app()->params['dateFormat'],$data->createdDate); ?>
    <br />
    ...
    <?php echo Yii::app()->dateFormatter->format(Yii::app()->params['dateFormat'],$data->updatedDate); ?>
    <br />
